document.addEventListener('DOMContentLoaded', () => {
    ...
    const renderFallback = () => {
        const fallbacks = [
            { id: 1, name: 'Luxe Cashmere Sweater', price: 149.99, image: 'https://images.unsplash.com/photo-1576566588028-4147f3842f27?q=80&w=1000&auto=format&fit=crop' },
            { id: 2, name: 'Midnight Velvet Blazer', price: 189.99, image: 'https://images.unsplash.com/photo-1507679799987-c7377ec48696?q=80&w=1000&auto=format&fit=crop' },
            { id: 3, name: 'Artisan Leather Boots', price: 219.00, image: 'https://images.unsplash.com/photo-1520639889313-7272a747ca90?q=80&w=1000&auto=format&fit=crop' },
            { id: 4, name: 'Satin Evening Gown', price: 165.50, image: 'https://images.unsplash.com/photo-1566174053879-31528523f8ae?q=80&w=1000&auto=format&fit=crop' }
        ];
